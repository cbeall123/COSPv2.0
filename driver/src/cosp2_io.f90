...
contains
  ...
  subroutine write_cosp2_output(Npoints, Ncolumns, Nlevels, lev, lon, lat, cospOUT, outFileName)
    ...
    if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
    status = nf90_def_dim(fileID,"SLWC_NCOT",SLWC_NCOT,dimID(19))
    if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
    ...
    if (associated(cospOUT%wr_occfreq_ntotal)) then
       ...
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfcld_cold",nf90_float, (/dimID(1)/),varID(143))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(143),"long_name","# of Supercooled Non-Precipitating Clouds, MODIS-CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(143),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(143),"standard_name", "number_of_supcool_cld_mc")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfdrz_cold",nf90_float, (/dimID(1)/),varID(144))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(144),"long_name","# of Supercooled Drizzling Clouds, MODIS-CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(144),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(144),"standard_name", "number_of_supcool_drz_mc")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfrain_cold",nf90_float, (/dimID(1)/),varID(145))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(145),"long_name","# of Supercooled Precipitating Clouds, MODIS-CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(145),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(145),"standard_name", "number_of_supcool_rain_mc")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfcld_multi",nf90_float, (/dimID(1)/),varID(146))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(146),"long_name","# of Multilayer Warm Non-precipitating Clouds, MODIS-CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(146),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(146),"standard_name", "number_of_multi_cld_mc")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfdrz_multi",nf90_float, (/dimID(1)/),varID(147))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(147),"long_name","# of Multilayer Warm Drizzling Clouds, MODIS-CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(147),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(147),"standard_name", "number_of_multi_drz_mc")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfrain_multi",nf90_float, (/dimID(1)/),varID(148))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(148),"long_name","# of Multilayer Warm Raining Clouds, MODIS-CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(148),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(148),"standard_name", "number_of_multi_rain_mc")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfslwc_mcal",nf90_float, (/dimID(1)/),varID(149))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(149),"long_name","# of SLWCs, MODIS+CALIPSO")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(149),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(149),"standard_name", "number_of_slwc_mcal")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"npdfslwc_calonly",nf90_float, (/dimID(1)/),varID(150))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(150),"long_name","# of SLWCs, CALIPSO only")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(150),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(150),"standard_name", "number_of_slwc_cal")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
    endif
    ! Contoured Frequency by Optical Depth Diagram (CFODD)
    if (associated(cospOUT%cfodd_ntotal)) then
       status = nf90_def_var(fileID,"CFODD_NTOTAL1",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(151))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(151),"long_name","# of CFODD (05 < Reff < 12 micron)")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(151),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(151),"standard_name", "cfodd_reff_small")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL2",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(152))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(152),"long_name","# of CFODD (12 < Reff < 18 micron)")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(152),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(152),"standard_name", "cfodd_reff_medium")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL3",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(153))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(153),"long_name","# of CFODD (18 < Reff < 30 micron)")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(153),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(153),"standard_name", "cfodd_reff_large")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL4",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(154))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(154),"long_name","# of CFODD (05 < Reff < 12 micron) MODIS COT < 20")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(154),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(154),"standard_name", "cfodd_reff_small_lcot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL5",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(155))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(155),"long_name","# of CFODD (12 < Reff < 18 micron) MODIS COT < 20")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(155),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(155),"standard_name", "cfodd_reff_med_lcot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL6",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(156))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(156),"long_name","# of CFODD (18 < Reff < 30 micron) MODIS COT < 20")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(156),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(156),"standard_name", "cfodd_reff_large_lcot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL7",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(157))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(157),"long_name","# of CFODD (5 < Reff < 12 micron) 4 < MODIS COT < 20")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(157),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(157),"standard_name", "cfodd_reff_small_4-20cot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL8",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(158))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(158),"long_name","# of CFODD (12 < Reff < 18 micron) 4 < MODIS COT < 20")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(158),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(158),"standard_name", "cfodd_reff_med_4-20cot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NTOTAL9",nf90_float, (/dimID(1),dimID(17),dimID(18)/),varID(159))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(159),"long_name","# of CFODD (18 < Reff < 30 micron) 4 < MODIS COT < 20")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(159),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(159),"standard_name", "cfodd_reff_large_4-20cot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       
       status = nf90_def_var(fileID,"SLWC_COT1",nf90_float,(/dimID(1),dimID(19)/),varID(160))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(160),"standard_name", "slwc_cot_cfodd1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(160),"long_name","# of SLWCs (05 <= Reff < 12 micron) binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(160),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT2",nf90_float,(/dimID(1),dimID(19)/),varID(161))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(161),"standard_name", "slwc_cot_cfodd2")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(161),"long_name","# of SLWCs (12 < Reff <= 18 micron) binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(161),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT3",nf90_float,(/dimID(1),dimID(19)/),varID(162))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(162),"standard_name", "slwc_cot_cfodd3")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(162),"long_name","# of SLWCs (18 <= Reff < 35 micron) binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(162),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT4",nf90_float,(/dimID(1),dimID(19)/),varID(163))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(163),"standard_name", "slwc_cot_cfodd4")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(163),"long_name","# of SLWCs small Reff, max dBZ < 20, cot < 20, binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(163),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT5",nf90_float,(/dimID(1),dimID(19)/),varID(164))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(164),"standard_name", "slwc_cot_cfodd5")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(164),"long_name","# of SLWCs med Reff, max dBZ < 20, cot < 20, binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(164),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT6",nf90_float,(/dimID(1),dimID(19)/),varID(165))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(165),"standard_name", "slwc_cot_cfodd6")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(165),"long_name","# of SLWCs large Reff, max dBZ < 20, cot < 20, binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(165),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT7",nf90_float,(/dimID(1),dimID(19)/),varID(166))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(166),"standard_name", "slwc_cot_cfodd7")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(166),"long_name","# of SLWCs small Reff, max dBZ<20, 4<=cot<20, binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(166),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT8",nf90_float,(/dimID(1),dimID(19)/),varID(167))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(167),"standard_name", "slwc_cot_cfodd8")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(167),"long_name","# of SLWCs med Reff, max dBZ<20, 4<=cot<20, binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(167),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT9",nf90_float,(/dimID(1),dimID(19)/),varID(168))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(168),"standard_name", "slwc_cot_cfodd9")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(168),"long_name","# of SLWCs large Reff, max dBZ<20, 4<=cot<20, binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(168),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT10",nf90_float,(/dimID(1),dimID(19)/),varID(169))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(169),"standard_name", "slwc_cot_cfodd10")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(169),"long_name","# of SLWCs (05 <= Reff < 12 micron) detected by CALIPSO/MODIS binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(169),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT11",nf90_float,(/dimID(1),dimID(19)/),varID(170))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(170),"standard_name", "slwc_cot_cfodd11")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(170),"long_name","# of SLWCs (12 <= Reff < 18 micron) detected by CALIPSO/MODIS binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(170),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT12",nf90_float,(/dimID(1),dimID(19)/),varID(171))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(171),"standard_name", "slwc_cot_cfodd12")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(171),"long_name","# of SLWCs (18 <= Reff < 30 micron) detected by CALIPSO/MODIS binned by MODIS cloud optical thickness")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(171),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       
       !! extra-SLWC diagnostics
       status = nf90_def_var(fileID,"lsmallcot",nf90_float,(/dimID(1)/),varID(172))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(172),"long_name","# of liquid clouds with MODIS COT < 0.3")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(172),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(172),"standard_name", "lsmallcot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"mice",nf90_float,(/dimID(1)/),varID(173))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(173),"long_name","# of ice clouds MODIS")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(173),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(173),"standard_name", "lnice")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"lsmallreff",nf90_float,(/dimID(1)/),varID(174))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(174),"long_name","# of liquid clouds with MODIS Re < 5 um")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(174),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(174),"standard_name", "nliqc_tiny_re")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"lbigreff",nf90_float,(/dimID(1)/),varID(175))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(175),"long_name","# of liquid clouds with MODIS Re > 30 um")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(175),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(175),"standard_name", "nliqc_giant_re")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"nmultilcld",nf90_float,(/dimID(1)/),varID(176))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(176),"long_name","# of subcolumns with multilayer clouds excluded from SLWC analysis - MODIS/CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(176),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(176),"standard_name", "nmultilcld")
       status = nf90_def_var(fileID,"nmultilcld_cal",nf90_float,(/dimID(1)/),varID(177))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(177),"long_name","# of subcolumns with multilayer clouds excluded from SLWC analysis - CALIPSO")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(177),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(177),"standard_name", "nmultilcld_cal")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"nhetcld",nf90_float,(/dimID(1)/),varID(178))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(178),"long_name","# of subcolumns with heterogeneous clouds excluded from SLWC analysis - MODIS/CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(178),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(178),"standard_name", "nhetcld")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"nhetcld_cal",nf90_float,(/dimID(1)/),varID(179))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(179),"long_name","# of subcolumns with heterogeneous clouds excluded from SLWC analysis - CALIPSO")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(179),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(179),"standard_name", "nhetcld_cal")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"ncoldct",nf90_float,(/dimID(1)/),varID(180))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(180),"long_name","# of subcolumns with cloud top temp < 273 K excluded from SLWC analysis - MODIS/CloudSat")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(180),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(180),"standard_name", "ncoldct")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"ncoldct_cal",nf90_float,(/dimID(1)/),varID(181))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(181),"long_name","# of subcolumns with cloud top temp < 273 K excluded from SLWC analysis - CALIPSO")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(181),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(181),"standard_name", "ncoldct_cal")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"calice",nf90_float,(/dimID(1)/),varID(182))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(182),"long_name","# of subcolumns with ice detected by CALIPSO")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(182),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(182),"standard_name", "calice")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"obs_ntotal1",nf90_float,(/dimID(1)/),varID(183))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(183),"long_name","'# of total observations from warmrain diags")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(183),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"obs_ntotal2",nf90_float,(/dimID(1)/),varID(184))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(184),"standard_name", "obs_ntotal2")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(184),"long_name","'# of clear-sky observations from warmrain diags")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(184),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"obs_ntotal3",nf90_float,(/dimID(1)/),varID(185))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(185),"standard_name", "obs_ntotal3")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(185),"long_name","'# of clear-sky observations from warmrain diags")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(185),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"MODIS_CALIPSO_CF",nf90_float,(/dimID(1)/),varID(186))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(186),"standard_name", "modis_calipso_cf")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(186),"long_name","'MODIS or CALIPSO cloud fraction")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(186),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"MODISANDCALIPSO_CF",nf90_float,(/dimID(1)/),varID(187))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(187),"standard_name", "modis_and_calipso_cf")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(187),"long_name","'MODIS and CALIPSO cloud fraction")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(187),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"MODISANDCALIPSO_ICECF",nf90_float,(/dimID(1)/),varID(188))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(188),"standard_name", "modis_and_calipso_icecf")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(188),"long_name","'MODIS and CALIPSO ice cloud fraction")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(188),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"MODISANDCLOUDSAT_CF",nf90_float,(/dimID(1)/),varID(189))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(189),"standard_name", "modis_and_cloudsat_cf")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(189),"long_name","'MODIS and CloudSat cloud fraction")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(189),"units",        "1")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       !! axes for CFODD
       status = nf90_def_var(fileID,"CFODD_NDBZE",nf90_float,(/dimID(17)/),varID(190))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(190),"long_name","CloudSat+MODIS dBZe vs ICOD joint PDF X-axis")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(190),"units",        "dBZ")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(190),"standard_name", "cloudsat_quivalent_reflectivity_factor")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"CFODD_NICOD",nf90_float,(/dimID(18)/),varID(191))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(191),"long_name","CloudSat+MODIS dBZe vs ICOD joint PDF Y-axis")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(191),"units",        "none")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(191),"standard_name", "modis_in-cloud_optical_depth")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_def_var(fileID,"SLWC_COT",nf90_float,(/dimID(19)/),varID(192))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(192),"long_name","MODIS COT bins")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(192),"units",        "none")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_att(fileID,varID(192),"standard_name", "modis_cot")
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
    endif 
    ...
    if (associated(cospOUT%wr_occfreq_ntotal)) then
       ...
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(143),cospOUT%wr_occfreq_ntotal(:,4))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(144),cospOUT%wr_occfreq_ntotal(:,5))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(145),cospOUT%wr_occfreq_ntotal(:,6))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(146),cospOUT%wr_occfreq_ntotal(:,7))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(147),cospOUT%wr_occfreq_ntotal(:,8))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(148),cospOUT%wr_occfreq_ntotal(:,9))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(149),cospOUT%wr_occfreq_ntotal(:,10))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(150),cospOUT%wr_occfreq_ntotal(:,11))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
    endif
      !! Contoured Frequency by Optical Depth Diagram (CFODD)
    if (associated(cospOUT%cfodd_ntotal)) then
       status = nf90_put_var(fileID,varID(151),cospOUT%cfodd_ntotal(:,:,:,1))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(152),cospOUT%cfodd_ntotal(:,:,:,2))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(153),cospOUT%cfodd_ntotal(:,:,:,3))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(154),cospOUT%cfodd_ntotal(:,:,:,4))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(155),cospOUT%cfodd_ntotal(:,:,:,5))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(156),cospOUT%cfodd_ntotal(:,:,:,6))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(157),cospOUT%cfodd_ntotal(:,:,:,7))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(158),cospOUT%cfodd_ntotal(:,:,:,8))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(159),cospOUT%cfodd_ntotal(:,:,:,9))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
       !! CMB - Single Layer Warm Cloud COT PDFs
     if (associated(cospOUT%slwccot)) then
       status = nf90_put_var(fileID,varID(160),cospOUT%slwccot(:,:,1))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(161),cospOUT%slwccot(:,:,2))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(162),cospOUT%slwccot(:,:,3))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(163),cospOUT%slwccot(:,:,4))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(164),cospOUT%slwccot(:,:,5))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(165),cospOUT%slwccot(:,:,6))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(166),cospOUT%slwccot(:,:,7))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(167),cospOUT%slwccot(:,:,8))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(168),cospOUT%slwccot(:,:,9))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(169),cospOUT%slwccot(:,:,10))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(170),cospOUT%slwccot(:,:,11))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(171),cospOUT%slwccot(:,:,12))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
       !! CMB - Extra SLWC Diagnostics
     if (associated(cospOUT%lsmallcot)) then
       status = nf90_put_var(fileID,varID(172),cospOUT%lsmallcot(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%mice)) then
       status = nf90_put_var(fileID,varID(173),cospOUT%mice(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%lsmallreff)) then
       status = nf90_put_var(fileID,varID(174),cospOUT%lsmallreff(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%lbigreff)) then
       status = nf90_put_var(fileID,varID(175),cospOUT%lbigreff(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%nmultilcld)) then
       status = nf90_put_var(fileID,varID(176),cospOUT%nmultilcld(:,1))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(177),cospOUT%nmultilcld(:,2))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%nhetcld)) then
       status = nf90_put_var(fileID,varID(178),cospOUT%nhetcld(:,1))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(179),cospOUT%nhetcld(:,2))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%coldct)) then
       status = nf90_put_var(fileID,varID(180),cospOUT%coldct(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%coldct_cal)) then
       status = nf90_put_var(fileID,varID(181),cospOUT%coldct_cal(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%calice)) then
       status = nf90_put_var(fileID,varID(182),cospOUT%calice(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%obs_ntotal)) then
       status = nf90_put_var(fileID,varID(183),cospOUT%obs_ntotal(:,1))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(184),cospOUT%obs_ntotal(:,2))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(185),cospOUT%obs_ntotal(:,3))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%modis_calipso_cf)) then
       status = nf90_put_var(fileID,varID(186),cospOUT%modis_calipso_cf(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%modisandcalipso_cf)) then
       status = nf90_put_var(fileID,varID(187),cospOUT%modisandcalipso_cf(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%modisandcalipso_icecf)) then
       status = nf90_put_var(fileID,varID(188),cospOUT%modisandcalipso_icecf(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%modisandcloudsat_cf)) then
       status = nf90_put_var(fileID,varID(189),cospOUT%modisandcloudsat_cf(:))
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
     if (associated(cospOUT%cfodd_ntotal)) then 
       status = nf90_put_var(fileID,varID(190),CFODD_HISTDBZEcenters)
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(191),CFODD_HISTICODcenters)
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
       status = nf90_put_var(fileID,varID(192),SLWC_HISTCOTcenters)
       if (status .ne. nf90_NoERR) print*,trim(nf90_strerror(status))
     endif
